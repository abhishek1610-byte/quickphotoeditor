     ...
     {/* SEO & Informational Content Section */}
      <section style={{ maxWidth: '900px', margin: '60px auto 0', padding: '30px 20px', borderTop: '1px solid #334155', color: '#cbd5e1' }}>
        ...
        <p style={{ color: '#94a3b8', lineHeight: '1.7', marginBottom: '24px' }}>
          Quick Photo Editor offers a lightning-fast, browser-based image compression tool designed to optimize JPEG, PNG, and WebP images. Whether you need to compress photos for website optimization, email attachments, or online application forms, our tool balances maximum size reduction with crystal-clear visual quality.
        </p>
        ...
        <ol style={{ paddingLeft: '20px', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '24px' }}>
          <li>Upload your photo using the file picker or drag-and-drop zone.</li>
          <li>Adjust the compression quality slider according to your preference.</li>
          <li>Preview the output file size in real-time.</li>
          <li>Click Download to save your compressed image instantly.</li>
        </ol>
        ...
        <ul style={{ paddingLeft: '20px', lineHeight: '1.8', color: '#cbd5e1', marginBottom: '24px' }}>
          <li><strong>100% Client-Side Privacy:</strong> Your photos never leave your device or get uploaded to external servers.</li>
          <li><strong>Universal Format Support:</strong> Seamlessly compress JPG, PNG, and WebP files.</li>
          <li><strong>Real-time Preview:</strong> Fine-tune compression ratios while viewing the exact output size.</li>
          <li><strong>Zero Cost:</strong> Completely free to use with zero watermarks or registrations.</li>
        </ul>
        ...
        <div style={{ lineHeight: '1.7' }}>
          <p><strong>Does compressing an image reduce its clarity?</strong></p>
          <p style={{ color: '#94a3b8', marginBottom: '16px' }}>
            Our smart compression algorithms remove redundant metadata and optimize color structures, preserving sharp visual clarity even at moderate to high compression settings.
          </p>

          <p><strong>Is it safe to compress confidential documents or photos?</strong></p>
          <p style={{ color: '#94a3b8', marginBottom: '16px' }}>
            Yes, processing runs entirely inside your browser using HTML5 Canvas APIs. No file data travels over the internet.
          </p>
        </div>
      </section>   
    </div>
