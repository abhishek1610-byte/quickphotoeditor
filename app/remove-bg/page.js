  ...
  return (
    <div style={{ fontFamily: 'system-ui, sans-serif', backgroundColor: '#f8fafc', minHeight: '100vh', padding: '30px 16px' }}>
      <div style={{ maxWidth: '550px', margin: '0 auto', backgroundColor: '#ffffff', padding: '24px', borderRadius: '12px', border: '1px solid #e2e8f0' }}>
        ...
        <p style={{ color: '#64748b', fontSize: '14px', marginBottom: '20px' }}>Remove solid backgrounds to make transparent PNGs.</p>
            ...
            {processedUrl && (
              <div style={{ textAlign: 'center' }}>
                <div style={{
                  ...
                  <img src={processedUrl} alt="Transparent Preview" style={{ maxWidth: '100%', maxHeight: '250px', objectFit: 'contain' }} />
                </div>

                <a href={processedUrl} download="removed-bg.png" style={{ display: 'block', backgroundColor: '#16a34a', color: '#ffffff', textDecoration: 'none', padding: '12px', borderRadius: '6px', fontWeight: 'bold', fontSize: '15px' }}>
